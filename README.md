...
<ul type="disc">
	<tr>
		...
		<td>&#x1F4C4;<a href="https://github.com/hilal-bstn/ReCapProject/blob/master/Core/Aspects/Autofac/Performance/PerformanceAspect.cs">PerformanceAspect.cs</a><br>
					...
					<ul type="circle">
					 <td>&#128194;<a href="https://github.com/hilal-bstn/ReCapProject/tree/master/Core/Aspects/Autofac/Transaction">Transaction</a><td>&#128205;<t>Bir grup operasyonun sırayla, sağlıklı bir şekilde çalışması için transaction yönetimi yapılmıştır.<br>		 
				<ul type="circle">	 
